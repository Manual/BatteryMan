...
public: \
	DECLARE_CLASS(ABatteryDude, ACharacter, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/BatteryMan"), NO_API) \
...
#define BatteryMan_Source_BatteryMan_BatteryDude_h_20_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ABatteryDude); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ABatteryDude); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ABatteryDude(ABatteryDude&&); \
	NO_API ABatteryDude(const ABatteryDude&); \
public:
...
template<> BATTERYMAN_API UClass* StaticClass<class ABatteryDude>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID BatteryMan_Source_BatteryMan_BatteryDude_h
