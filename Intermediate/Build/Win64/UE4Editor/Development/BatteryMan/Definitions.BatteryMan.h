...
#define UE_PROJECT_NAME BatteryMan
#define UE_TARGET_NAME BatteryManEditor
...
#define BATTERYMAN_API DLLEXPORT
#define AUGMENTEDREALITY_API DLLIMPORT
#define MRMESH_API DLLIMPORT
#define ACHIEVEMENTSYSTEM_API DLLIMPORT
